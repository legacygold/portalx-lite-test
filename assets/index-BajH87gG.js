import{n as h,q as f,R as w,x as e,E as y}from"./index-Cr641yrG.js";import{r as u,c as g}from"./index-jOu9Tj9s.js";import"./index-BZu8U1B6.js";import{H as v}from"./HelpersUtil-C8ZPcI-Q.js";const b=h`
  :host {
    display: block;
  }
...
`;var p=function(a,t,n,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,t,n,r);else for(var c=a.length-1;c>=0;c--)(o=a[c])&&(i=(s<3?o(i):s>3?o(t,n,i):o(t,n))||i);return s>3&&i&&Object.defineProperty(t,n,i),i};let l=class extends f{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=w.state.view}firstUpdated(){this.status=v.hasFooter()?"show":"hide",this.unsubscribe.push(w.subscribeKey("view",t=>{this.view=t,this.status=v.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(t=>{for(const n of t)if(n.target===this.getWrapper()){const r=`${n.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",r)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
...
`;var d=function(a,t,n,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,t,n,r);else for(var c=a.length-1;c>=0;c--)(o=a[c])&&(i=(s<3?o(i):s>3?o(t,n,i):o(t,n))||i);return s>3&&i&&Object.defineProperty(t,n,i),i};let m=class extends f{constructor(){super(),this.unsubscribe=[],this.viewState=w.state.view,this.history=w.state.history.join(","),this.unsubscribe.push(w.subscribeKey("view",()=>{this.history=w.state.history.join(","),document.documentElement.style.setProperty("--apkt-duration-dynamic","var(--apkt-durations-lg)")}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),document.documentElement.style.setProperty("--apkt-duration-dynamic","0s")}render(){return e`${this.templatePageContainer()}`}templatePageContainer(){return e`<w3m-router-container
